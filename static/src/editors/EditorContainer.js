define(['Control', 'TabPanel', 'rpc/storage', 'dialogs/OpenDialog', 'lib/bcsocket', 'share/share','dialogs/InputDialog'],
    function(Control, TabPanel, storage, OpenDialog, bcsocket, share, InputDialog){
    ...
    EditorContainer.prototype.open = function(itemToOpen, callback){
        ...
        if(this.openItems[itemToOpen.name || itemToOpen.title]){
            ...
            this.addTab({
                ...
                sharejs.open(itemToOpen.name, 'text', function(error, doc) {
                    newPanel.panelItem.setDoc(doc);
...
//                callback(err, newPanel);
    ...
    EditorContainer.prototype.save = function(callback){
        ...
        if(this.activeTab){
            ...
            storage.setObject(editor.item,function(err, updatedObject){
